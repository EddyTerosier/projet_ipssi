...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 11 oct. 2023 à 13:50
...
(4, 'test', 'test', 'test@test.test', '123'),
(3, 'test', 'test', 'test@test.test', '123'),
(5, 'Jean', 'Dupont', 'jean@dupont.com', '123'),
(6, 'test', 'test2', 'test@test.fr', '123');
COMMIT;
