        ...
        <div class="row justify-content-center mb-5">
          <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="p-2 mt-4">
                  <form action="inscription.html">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="position-relative auth-pass-inputgroup mb-3">
                        <input type="password" class="form-control pe-5 password-input" placeholder="Confirmer votre mot de passe" />
                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button">
                          <i class="ri-eye-fill align-middle"></i>
                        </button>
                      </div>
            ...
            <div class="mt-4 text-center">
              <p class="mb-0">Vous avez déjà un compte ? <a href="connexion.html" class="fw-semibold text-primary text-decoration-underline"> S'inscrire </a></p>
            </div>
          </div>
        </div>
        <!-- end row -->
